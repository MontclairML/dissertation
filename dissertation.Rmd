...
## Sample Size 100,000 and EPV 10,000
...
A logistic regression analysis was conducted to predict outcomes based on a set of predictors. Overall accuracy across categories was `r metricsLOGI$F1.Score[3]`, as can be seen in table \@ref(tab:logitable100k). The macro average precision was `r metricsLOGI$Precision[4]`, with a recall of `r metricsLOGI$Recall[4]` and an F1 score of `r metricsLOGI$F1.Score[4]`, suggesting a moderate level of prediction consistency across categories. 
The performance of a xgboosting model across categories was `r metricsXGB$F1.Score[3]`, as can be seen in table \@ref(tab:xgbtable100k). The macro average precision was `r metricsXGB$Precision[4]`, with a recall of `r metricsXGB$Recall[4]` and an F1 score of `r metricsXGB$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
The performance of a neural network model across categories was `r metricsNN$F1.Score[3]`, as can be seen in table \@ref(tab:nn100k). The macro average precision was `r metricsNN$Precision[4]`, with a recall of `r metricsNN$Recall[4]` and an F1 score of `r metricsNN$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
The performance of a SVM model across categories was `r metricsSVM$F1.Score[3]`, as can be seen in table \@ref(tab:svm100k). The macro average precision was `r metricsSVM$Precision[4]`, with a recall of `r metricsSVM$Recall[4]` and an F1 score of `r metricsSVM$F1.Score[4]`, suggesting moderate levels of predictive accuracy.
The performance of a random forest model across categories was `r metricsRF$F1.Score[3]`, as can be seen in table \@ref(tab:rf100k). The macro average precision was `r metricsRF$Precision[4]`, with a recall of `r metricsRF$Recall[4]` and an F1 score of `r metricsRF$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 

## Sample Size 10,000 and EPV 1,000
...
A logistic regression analysis was conducted to predict outcomes based on a set of predictors. Overall accuracy across categories was `r metricsLOGI$F1.Score[3]`, as can be seen in Table \@ref(tab:logitable10k). The macro average precision was `r metricsLOGI$Precision[4]`, with a recall of `r metricsLOGI$Recall[4]` and an F1 score of `r metricsLOGI$F1.Score[4]`, suggesting a moderate level of prediction consistency across categories. 
The performance of a xgboosting model across categories was `r metricsXGB$F1.Score[3]`, as can be seen in table \@ref(tab:xgbtable10k). The macro average precision was `r metricsXGB$Precision[4]`, with a recall of `r metricsXGB$Recall[4]` and an F1 score of `r metricsXGB$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
The performance of a neural network model across categories was `r metricsNN$F1.Score[3]`, as can be seen in table \@ref(tab:nn10k). The macro average precision was `r metricsNN$Precision[4]`, with a recall of `r metricsNN$Recall[4]` and an F1 score of `r metricsNN$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
The performance of a SVM model across categories was `r metricsSVM$F1.Score[3]`, as can be seen in table \@ref(tab:svm10k). The macro average precision was `r metricsSVM$Precision[4]`, with a recall of `r metricsSVM$Recall[4]` and an F1 score of `r metricsSVM$F1.Score[4]`, suggesting moderate levels of predictive accuracy.
The performance of a random forest model across categories was `r metricsRF$F1.Score[3]`, as can be seen in table \@ref(tab:rf10k). The macro average precision was `r metricsRF$Precision[4]`, with a recall of `r metricsRF$Recall[4]` and an F1 score of `r metricsRF$F1.Score[4]`, suggesting moderate levels of predictive accuracy.


## Sample Size 1,000 and EPV 100
...
A logistic regression analysis was conducted to predict outcomes based on a set of predictors. Overall accuracy across categories was `r metricsLOGI$F1.Score[3]`, as can be seen in Table \@ref(tab:logitable1k). The macro average precision was `r metricsLOGI$Precision[4]`, with a recall of `r metricsLOGI$Recall[4]` and an F1 score of `r metricsLOGI$F1.Score[4]`, suggesting a moderate level of prediction consistency across categories. 
The performance of a xgboosting model across categories was `r metricsXGB$F1.Score[3]`, as can be seen in table \@ref(tab:xgbtable1k). The macro average precision was `r metricsXGB$Precision[4]`, with a recall of `r metricsXGB$Recall[4]` and an F1 score of `r metricsXGB$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
The performance of a neural network model across categories was `r metricsNN$F1.Score[3]`, as can be seen in table \@ref(tab:nn1k). The macro average precision was `r metricsNN$Precision[4]`, with a recall of `r metricsNN$Recall[4]` and an F1 score of `r metricsNN$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
The performance of a SVM model across categories was `r metricsSVM$F1.Score[3]`, as can be seen in table \@ref(tab:svm1k). The macro average precision was `r metricsSVM$Precision[4]`, with a recall of `r metricsSVM$Recall[4]` and an F1 score of `r metricsSVM$F1.Score[4]`, suggesting moderate levels of predictive accuracy.
The performance of a random forest model across categories was `r metricsRF$F1.Score[3]`, as can be seen in table \@ref(tab:rf1k). The macro average precision was `r metricsRF$Precision[4]`, with a recall of `r metricsRF$Recall[4]` and an F1 score of `r metricsRF$F1.Score[4]`, suggesting moderate levels of predictive accuracy.


## Sample Size 200 and EPV 20
...
A logistic regression analysis was conducted to predict outcomes based on a set of predictors. Overall accuracy across categories was `r metricsLOGI$F1.Score[3]`, as can be seen in Table \@ref(tab:logitable200). The macro average precision was `r metricsLOGI$Precision[4]`, with a recall of `r metricsLOGI$Recall[4]` and an F1 score of `r metricsLOGI$F1.Score[4]`, suggesting a moderate level of prediction consistency across categories. 
The performance of a xgboosting model across categories was `r metricsXGB$F1.Score[3]`, as can be seen in table \@ref(tab:xgbtable200). The macro average precision was `r metricsXGB$Precision[4]`, with a recall of `r metricsXGB$Recall[4]` and an F1 score of `r metricsXGB$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
The performance of a neural network model across categories was `r metricsNN$F1.Score[3]`, as can be seen in table \@ref(tab:nn200). The macro average precision was `r metricsNN$Precision[4]`, with a recall of `r metricsNN$Recall[4]` and an F1 score of `r metricsNN$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
The performance of a SVM model across categories was `r metricsSVM$F1.Score[3]`, as can be seen in table \@ref(tab:svm200). The macro average precision was `r metricsSVM$Precision[4]`, with a recall of `r metricsSVM$Recall[4]` and an F1 score of `r metricsSVM$F1.Score[4]`, suggesting moderate levels of predictive accuracy.
The performance of a random forest model across categories was `r metricsRF$F1.Score[3]`, as can be seen in table \@ref(tab:rf200). The macro average precision was `r metricsRF$Precision[4]`, with a recall of `r metricsRF$Recall[4]` and an F1 score of `r metricsRF$F1.Score[4]`, suggesting moderate levels of predictive accuracy.
