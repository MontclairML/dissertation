...
The performance of a xgboosting model across categories was `r metricsXGB$F1.Score[3]`, as can be seen in table \ref@(tab:xgb100k). The macro average precision was `r metricsXGB$Precision[4]`, with a recall of `r metricsXGB$Recall[4]` and an F1 score of `r metricsXGB$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
...
The performance of a xgboosting model across categories was `r metricsXGB$F1.Score[3]`, as can be seen in table \ref@(tab:xgb10k). The macro average precision was `r metricsXGB$Precision[4]`, with a recall of `r metricsXGB$Recall[4]` and an F1 score of `r metricsXGB$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
...
The performance of a xgboosting model across categories was `r metricsXGB$F1.Score[3]`, as can be seen in table \ref@(tab:xgb1k). The macro average precision was `r metricsXGB$Precision[4]`, with a recall of `r metricsXGB$Recall[4]` and an F1 score of `r metricsXGB$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
...
The performance of a xgboosting model across categories was `r metricsXGB$F1.Score[3]`, as can be seen in table \ref@(tab:xgb200). The macro average precision was `r metricsXGB$Precision[4]`, with a recall of `r metricsXGB$Recall[4]` and an F1 score of `r metricsXGB$F1.Score[4]`, suggesting moderate levels of predictive accuracy. 
